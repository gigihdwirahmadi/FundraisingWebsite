        ...
        <table class=" table table-dark ">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= miniframework2\app\core\Router::Url("/public/detailtrxprogram/$row->idtrx") ?>"
                        class="btn btn-light">detail</a>
                    <?php } else { ?> Finish <?php } ?>

                </td>
                <td style="text-align: center;">
                    <form action="<?= \miniframework2\App\Core\Router::Url("/public/deleteprogramtrx")?>" method="POST">
